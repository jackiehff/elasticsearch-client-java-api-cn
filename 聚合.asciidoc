...
Elasticsearch 提供了一套完整的 Java API 来使用聚合. 参见 {ref}/search-aggregations.html[聚合指南].
...
请注意, 你可以添加多个聚合. 详情参见 {ref}/search-search.html[Java搜索API].
...
正如{ref}/search-aggregations.html[聚合指南]中的解释, 你可以在聚合内部定义一个子聚合.
